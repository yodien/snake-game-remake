...
public class GameBoardPanel extends JPanel implements ActionListener {
    ...
    public void DrawStatusbar(Graphics2D g2) {
        ...
        g2.drawString("Press Spacebar for pause!", 5, 40);
        /////
        g2.drawString("Press w,a,s,d to controll the snake!", 5, 60);
        g2.drawString("Green item will slow down the snake.", 810, 20);
        g2.drawString("Blue item will shrink the snake size", 810, 40);
        
        if (mode == 1) {
        	g2.drawString("you can only see the special", 5, 200);
        	g2.drawString("items and walls in when snake", 5, 220);
        	g2.drawString("is nearby", 5, 240);
        }
        //////////
